...
* **`.github/workflows/`** — содержит конфигурацию GitHub Actions (`cpp-check.yml`) для автоматической проверки стиля и качества кода (`clang-format` и `cpplint`) при отправке изменений в ветку `master`.
